// RimTown - Frontend App (WordPress Plugin) v3.2.3
const RIMTOWN_APP_VERSION = '3.2.3';
...
class RimTownApp {
    ...
    _updateHeaderTownName(name) {
        const h1 = document.querySelector('#rimtown-app .header h1') || document.querySelector('.header h1');
