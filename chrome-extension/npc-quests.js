...
const NPC_PERSONAL_QUESTS = {
    'liu_jun': {
        name: t('劉俊'), job: 'farmer',
        quests: [
            {
                id: 'liu_jun_letter',
                title: t('未寄出的情書'),
                trigger: { affinity: 30 },
                description: t('劉俊偷偷寫了一封情書給許瑩，但不敢寄出...'),
                icon: '💌',
                routes: [
                    { id: 'deliver', label: t('幫他送出情書'), icon: '📮',
                      conditions: [
                          { type: 'talk_to', npcId: 'xu_ying', topic: 'liu_jun_letter', label: t('把情書交給許瑩') },
                          { type: 'report_back', npcId: 'liu_jun', label: t('回報劉俊結果') },
                      ]},
                    { id: 'encourage', label: t('鼓勵他自己去'), icon: '💪',
                      conditions: [
                          { type: 'npc_affinity', npcId: 'liu_jun', target: 60, label: t('與劉俊好感度達到 60') },
                          { type: 'chat_with', npcId: 'liu_jun', target: 3, label: t('鼓勵劉俊 3 次') },
                      ]},
                ],
                ...
                onComplete: t('劉俊終於跨出了那一步。不管結果如何，他都很感激你。'),
                unlocks: ['xu_ying_new_design'],
                npcHints: {
                    liu_jun: { minAffinity: 20, hint: t('其實...有件事我想找人幫忙，但有點不好意思說...') },
                    xu_ying: { minAffinity: 15, hint: t('最近劉俊看到我就臉紅，真是奇怪...') },
                },
            },
            {
                id: 'liu_jun_grandpa',
                ...
                description: t('劉俊的爺爺留下一本古老的種植手札，裡面記載了失傳的稀有作物種植法...'),
                icon: '📖',
                routes: [
                    { id: 'study', label: t('一起研究手札'), icon: '🔍',
                      conditions: [
                          { type: 'resource', resource: 'food', target: 50, label: t('提供 50 食物作為實驗材料') },
                          { type: 'chat_with', npcId: 'liu_jun', target: 5, label: t('與劉俊討論手札 5 次') },
                      ]},
                ],
                ...
                onComplete: t('你們成功解讀了手札中的秘密！農場產量將會提升。'),
                npcHints: {
                    liu_jun: { minAffinity: 40, hint: t('我爺爺留下一本種植手札...不知道你有沒有興趣看看？') },
                },
            },
        ],
    },
        ...
        quests: [
            {
                ...
                description: t('吳達說年輕時發現過一條金礦脈，但礦坑塌了...'),
                icon: '⛏️',
                routes: [
                    { id: 'explore', label: t('跟他一起去找'), icon: '🗺️',
                      conditions: [
                          { type: 'resource', resource: 'wood', target: 40, label: t('準備 40 木材加固礦道') },
                          { type: 'resource', resource: 'metal', target: 10, label: t('準備 10 金屬做工具') },
                          { type: 'npc_affinity', npcId: 'wu_da', target: 55, label: t('吳達好感度達到 55') },
                      ]},
                    { id: 'hire', label: t('組織探礦隊'), icon: '👷',
                      conditions: [
                          { type: 'resource', resource: 'silver', target: 100, label: t('支付 100 銀幣僱人') },
                          { type: 'population', target: 12, label: t('鎮上至少 12 人') },
                      ]},
                ],
                ...
                onComplete: t('你們找到了傳說中的金礦脈！吳達激動得說不出話來。'),
                npcHints: {
                    wu_da: { minAffinity: 30, hint: t('年輕時我在廢礦裡看到過會發光的石頭...你信嗎？') },
                },
            },
            {
                id: 'wu_da_apprentice',
                title: t('尋找傳人'),
                trigger: { affinity: 70 },
                description: t('吳達覺得自己年紀大了，想找人傳承採礦技術...'),
                icon: '👴',
                routes: [
                    { id: 'learn', label: t('你來學'), icon: '📚',
                      conditions: [
                          { type: 'chat_with', npcId: 'wu_da', target: 8, label: t('跟吳達學習 8 次') },
                      ]},
                    { id: 'find', label: t('幫他找徒弟'), icon: '🔎',
                      conditions: [
                          { type: 'avg_affinity', target: 30, label: t('全鎮平均好感度 30+') },
                          { type: 'population', target: 15, label: t('鎮上至少 15 人') },
                      ]},
                ],
                ...
                onComplete: t('吳達的技術不會失傳了。他笑得像個孩子。'),
                npcHints: {
                    wu_da: { minAffinity: 60, hint: t('唉...我這把老骨頭還能挖幾年呢...') },
                },
            },
        ],
    },
    'xu_ying': {
        name: t('許瑩'), job: 'tailor',
        quests: [
            {
                id: 'xu_ying_new_design',
                title: t('夢想中的新衣'),
                trigger: { affinity: 35, requireFlag: 'liu_xu_dating' },
                description: t('許瑩想設計一套全新的服飾，作為送給劉俊的禮物...'),
                icon: '👗',
                routes: [
                    { id: 'materials', label: t('幫她收集材料'), icon: '🧵',
                      conditions: [
                          { type: 'resource', resource: 'silver', target: 30, label: t('提供 30 銀幣買布料') },
                          { type: 'chat_with', npcId: 'xu_ying', target: 3, label: t('與許瑩討論設計 3 次') },
                      ]},
                ],
                ...
                onComplete: t('許瑩的新作品讓全鎮驚艷！她感激地看著你。'),
                npcHints: {
                    xu_ying: { minAffinity: 30, hint: t('我最近有個設計靈感...但需要一些材料...') },
                },
            },
            {
                id: 'xu_ying_fashion',
                ...
                description: t('許瑩想在鎮上辦一場時裝秀，展示她所有的作品...'),
                icon: '✨',
                routes: [
                    { id: 'organize', label: t('幫她籌辦'), icon: '🎪',
                      conditions: [
                          { type: 'resource', resource: 'silver', target: 80, label: t('支付 80 銀幣場地費') },
                          { type: 'friends_count', target: 5, label: t('邀請至少 5 位朋友來看') },
                      ]},
                ],
                ...
                onComplete: t('邊境鎮第一場時裝秀圓滿成功！全鎮歡慶！'),
                npcHints: {
                    xu_ying: { minAffinity: 50, hint: t('你覺得我們鎮上能辦一場時裝秀嗎...？') },
                },
            },
        ],
    },
        ...
        quests: [
            {
                ...
                title: t('鎮長的過去'),
                trigger: { affinity: 40 },
                description: t('陳偉似乎有著不為人知的過去。他偶爾會望著遠方發呆...'),
                icon: '🏛️',
                routes: [
                    { id: 'listen', label: t('傾聽他的故事'), icon: '👂',
                      conditions: [
                          { type: 'chat_with', npcId: 'chen_wei', target: 6, label: t('與陳偉深談 6 次') },
                          { type: 'npc_affinity', npcId: 'chen_wei', target: 60, label: t('陳偉好感度達到 60') },
                      ]},
                ],
                ...
                onComplete: t('陳偉第一次向人敞開心扉。「謝謝你願意聽我說...」'),
                npcHints: {
                    chen_wei: { minAffinity: 30, hint: t('有時候我會想...當初離開京城到底是對是錯...') },
                },
            },
            {
                id: 'chen_wei_legacy',
                ...
                description: t('陳偉想在卸任前為小鎮留下一份珍貴的禮物——一部完整的鎮志...'),
                icon: '📜',
                routes: [
                    { id: 'chronicle', label: t('幫他撰寫鎮志'), icon: '✍️',
                      conditions: [
                          { type: 'chat_count', target: 20, label: t('總對話次數達到 20') },
                          { type: 'friends_count', target: 8, label: t('認識至少 8 位鎮民') },
                          { type: 'npc_affinity', npcId: 'chen_wei', target: 80, label: t('陳偉好感度達到 80') },
                      ]},
                ],
                ...
                onComplete: t('《邊境鎮志》完成了。陳偉老淚縱橫：「這個鎮的故事，值得被記住。」'),
                npcHints: {
                    chen_wei: { minAffinity: 60, hint: t('如果有人能把這個鎮的故事記下來就好了...') },
                },
            },
        ],
    },
    'lin_mei': {
        name: t('林美'), job: 'doctor',
        quests: [
            {
                id: 'lin_mei_herb',
                title: t('失傳的草藥方'),
                trigger: { affinity: 35 },
                description: t('林美在整理醫書時發現一個古老的草藥配方，但缺少關鍵藥材...'),
                icon: '🌿',
                routes: [
                    { id: 'gather', label: t('幫她採集藥材'), icon: '🌱',
                      conditions: [
                          { type: 'resource', resource: 'food', target: 30, label: t('採集 30 份草藥（食物類）') },
                          { type: 'chat_with', npcId: 'lin_mei', target: 3, label: t('與林美討論配方 3 次') },
                      ]},
                ],
                ...
                onComplete: t('林美成功還原了古老的草藥配方！「有了這個，鎮上的人都能更健康了。」'),
                npcHints: {
                    lin_mei: { minAffinity: 25, hint: t('我最近在舊醫書裡發現了一個有趣的配方...') },
                },
            },
            {
                id: 'lin_mei_clinic',
                ...
                description: t('林美想建一座真正的診所，不再是在帳篷裡看病...'),
                icon: '🏥',
                routes: [
                    { id: 'build', label: t('幫她建診所'), icon: '🏗️',
                      conditions: [
                          { type: 'resource', resource: 'wood', target: 60, label: t('提供 60 木材') },
                          { type: 'resource', resource: 'stone', target: 30, label: t('提供 30 石材') },
                          { type: 'building_count', target: 4, label: t('鎮上至少 4 座建築') },
                      ]},
                ],
                ...
                onComplete: t('新診所落成了！林美感動地說：「終於可以好好照顧大家了。」'),
                npcHints: {
                    lin_mei: { minAffinity: 45, hint: t('如果能有一間真正的診所就好了...帳篷裡實在不方便。') },
                },
            },
        ],
    },
    'zhang_hao': {
        name: t('張豪'), job: 'blacksmith',
        quests: [
            {
                id: 'zhang_hao_sword',
                title: t('傳說中的鑄劍術'),
                trigger: { affinity: 45 },
                description: t('張豪一直想重現失傳的古代鑄劍術，但需要特殊的材料...'),
                icon: '⚔️',
                routes: [
                    { id: 'materials', label: t('幫他收集材料'), icon: '⛓️',
                      conditions: [
                          { type: 'resource', resource: 'metal', target: 30, label: t('提供 30 金屬') },
                          { type: 'resource', resource: 'wood', target: 20, label: t('提供 20 木材（木炭用）') },
                      ]},
                    { id: 'research', label: t('找資料'), icon: '📖',
                      conditions: [
                          { type: 'chat_with', npcId: 'sun_yu', target: 3, label: t('請孫雨幫忙查古籍 3 次') },
                          { type: 'npc_affinity', npcId: 'zhang_hao', target: 60, label: t('張豪好感度達到 60') },
                      ]},
                ],
                ...
                onComplete: t('張豪成功鑄出了傳說級的武器！「這是我一生的巔峰之作！」'),
        ...
        quests: [
            {
                ...
                title: t('王麗的秘方'),
                trigger: { affinity: 30 },
                description: t('王麗想用她母親留下的秘方，為全鎮準備一場盛宴...'),
                icon: '🍳',
                routes: [
                    { id: 'ingredients', label: t('幫她準備材料'), icon: '🥘',
                      conditions: [
                          { type: 'resource', resource: 'food', target: 60, label: t('準備 60 食物') },
                          { type: 'resource', resource: 'silver', target: 20, label: t('購買 20 銀幣的香料') },
                      ]},
                ],
                rewards: { reputation: 8, silver: 40 },
                outcomes: {
                ...
                onComplete: t('全鎮大宴！每個人都吃得心滿意足，王麗笑開了花。'),
                npcHints: {
                    wang_li: { minAffinity: 20, hint: t('我媽媽留了一道拿手菜的食譜給我...但材料不太好找。') },
                },
            },
            {
                ...
                title: t('開一間餐館'),
                trigger: { affinity: 55, chapter: 3 },
                description: t('王麗夢想開一間正式的餐館，讓鎮民有個聚會的好地方...'),
                icon: '🏪',
                routes: [
                    { id: 'build', label: t('幫她開餐館'), icon: '🏗️',
                      conditions: [
                          { type: 'resource', resource: 'wood', target: 50, label: t('提供 50 木材') },
                          { type: 'resource', resource: 'silver', target: 100, label: t('投資 100 銀幣') },
                          { type: 'building_count', target: 5, label: t('鎮上至少 5 座建築') },
                      ]},
                ],
                ...
                onComplete: t('「邊境小館」正式開張！王麗的手藝讓路過的商人都驚豔不已。'),
                npcHints: {
                    wang_li: { minAffinity: 45, hint: t('如果有一天我能開間餐館就好了...') },
                },
            },
        ],
    },
    'zhao_xia': {
        name: t('趙霞'), job: 'trader',
        quests: [
            {
                id: 'zhao_xia_route',
                title: t('新的貿易路線'),
                trigger: { affinity: 35 },
                description: t('趙霞聽說山的另一邊有個繁華的城鎮，想開拓新的貿易路線...'),
                icon: '🛤️',
                routes: [
                    { id: 'scout', label: t('一起去探路'), icon: '🗺️',
                      conditions: [
                          { type: 'resource', resource: 'food', target: 40, label: t('準備 40 食物做路糧') },
                          { type: 'npc_affinity', npcId: 'zhao_xia', target: 50, label: t('趙霞好感度達到 50') },
                      ]},
                    { id: 'fund', label: t('資助她'), icon: '💰',
                      conditions: [
                          { type: 'resource', resource: 'silver', target: 150, label: t('提供 150 銀幣資金') },
                      ]},
                ],
        ...
        quests: [
            {
                ...
                title: t('守衛的訓練'),
                trigger: { affinity: 30 },
                description: t('楊鋒想組織一支像樣的巡邏隊，保護小鎮的安全...'),
                icon: '🛡️',
                routes: [
                    { id: 'train', label: t('一起訓練'), icon: '⚔️',
                      conditions: [
                          { type: 'resource', resource: 'metal', target: 15, label: t('提供 15 金屬做訓練武器') },
                          { type: 'chat_with', npcId: 'yang_feng', target: 4, label: t('與楊鋒訓練 4 次') },
                      ]},
                ],
                ...
                onComplete: t('巡邏隊成立了！楊鋒信心滿滿地說：「這下沒人敢來鬧事了。」'),
                npcHints: {
                    yang_feng: { minAffinity: 20, hint: t('光靠我一個人守不住整個鎮子啊...') },
                },
            },
            {
                id: 'yang_feng_blade',
                ...
                description: t('聽說張豪練成了傳說級的鑄劍術，楊鋒想請他打一把好武器...'),
                icon: '🗡️',
                routes: [
                    { id: 'commission', label: t('幫他牽線'), icon: '🤝',
                      conditions: [
                          { type: 'npc_affinity', npcId: 'zhang_hao', target: 40, label: t('張豪好感度達到 40') },
                          { type: 'resource', resource: 'metal', target: 20, label: t('提供 20 金屬做材料') },
                      ]},
                ],
                rewards: { reputation: 10 },
                outcomes: {
                ...
                onComplete: t('楊鋒拿到新武器，激動地舞了一套劍法。「有了這把劍，誰來都不怕！」'),
                npcHints: {
                    yang_feng: { minAffinity: 40, hint: t('聽說張豪最近在研究什麼新的鍛造技術？') },
                },
            },
        ],
    },
    'sun_yu': {
        name: t('孫雨'), job: 'researcher',
        quests: [
            {
                id: 'sun_yu_discovery',
                title: t('古代遺跡的線索'),
                trigger: { affinity: 40 },
                description: t('孫雨在研究中發現了關於附近古代遺跡的線索...'),
                icon: '🔬',
                routes: [
                    { id: 'investigate', label: t('一起調查'), icon: '🏛️',
                      conditions: [
                          { type: 'resource', resource: 'silver', target: 50, label: t('提供 50 銀幣研究經費') },
                          { type: 'chat_with', npcId: 'sun_yu', target: 5, label: t('與孫雨討論發現 5 次') },
                      ]},
                ],
                rewards: { reputation: 15, silver: 80 },
                outcomes: {
                ...
                onComplete: t('你們發現了古代文明的遺跡！孫雨興奮得手都在抖。「這是改寫歷史的發現！」'),
                npcHints: {
                    sun_yu: { minAffinity: 30, hint: t('最近我在北邊的山洞裡發現了一些奇怪的符號...') },
                },
            },
            {
                id: 'sun_yu_library',
                title: t('建造圖書館'),
                trigger: { affinity: 60, chapter: 3 },
                description: t('孫雨希望建一座圖書館，保存所有的研究成果和知識...'),
                icon: '📚',
                routes: [
                    { id: 'build', label: t('幫他建圖書館'), icon: '🏗️',
                      conditions: [
                          { type: 'resource', resource: 'wood', target: 80, label: t('提供 80 木材') },
                          { type: 'resource', resource: 'stone', target: 40, label: t('提供 40 石材') },
                          { type: 'resource', resource: 'silver', target: 60, label: t('提供 60 銀幣') },
                      ]},
                ],
                ...
                onComplete: t('圖書館建成了！孫雨小心翼翼地把書一本本擺上書架。「知識是最珍貴的財富。」'),
                npcHints: {
                    sun_yu: { minAffinity: 50, hint: t('這些研究成果如果沒有好好保存，太可惜了...') },
                },
            },
        ],
    },
    'huang_li': {
        name: t('黃莉'), job: 'priest',
        quests: [
            {
                id: 'huang_li_shrine',
                title: t('重建神龕'),
                trigger: { affinity: 35 },
                description: t('黃莉想在鎮上重建一座被風暴摧毀的古老神龕...'),
                icon: '⛩️',
                routes: [
                    { id: 'rebuild', label: t('幫她重建'), icon: '🏗️',
                      conditions: [
                          { type: 'resource', resource: 'stone', target: 25, label: t('提供 25 石材') },
                          { type: 'resource', resource: 'wood', target: 15, label: t('提供 15 木材') },
                          { type: 'chat_with', npcId: 'huang_li', target: 3, label: t('與黃莉祈禱 3 次') },
                      ]},
                ],
                ...
                onComplete: t('神龕重建完成。黃莉在晨光中虔誠祈禱：「願這片土地上的所有人都平安。」'),
                npcHints: {
                    huang_li: { minAffinity: 25, hint: t('那座被毀的老神龕...我一直想把它修好。') },
                },
            },
            {
                ...
                title: t('豐收祭典'),
                trigger: { affinity: 55, chapter: 2 },
                description: t('黃莉想舉辦一場傳統的豐收祭典，祈求來年風調雨順...'),
                icon: '🎊',
                routes: [
                    { id: 'prepare', label: t('幫她準備祭典'), icon: '🎉',
                      conditions: [
                          { type: 'resource', resource: 'food', target: 80, label: t('準備 80 食物做祭品') },
                          { type: 'resource', resource: 'silver', target: 40, label: t('支付 40 銀幣買裝飾') },
                          { type: 'friends_count', target: 6, label: t('邀請至少 6 位鎮民參加') },
                      ]},
                ],
                ...
                onComplete: t('豐收祭典圓滿成功！鎮民們載歌載舞，其樂融融。'),
                npcHints: {
                    huang_li: { minAffinity: 45, hint: t('如果能辦一場豐收祭典，大家的心情一定會好很多...') },
                },
            },
        ],
    },
    'ma_qiang': {
        name: t('馬強'), job: 'carpenter',
        quests: [
            {
                id: 'ma_qiang_masterwork',
                title: t('千年古木的傳說'),
                trigger: { affinity: 50 },
                description: t('馬強說北山有一棵千年古木，用它的木材可以打造傳世之作...'),
                icon: '🪓',
                routes: [
                    { id: 'expedition', label: t('一起去北山'), icon: '🏔️',
                      conditions: [
                          { type: 'resource', resource: 'food', target: 30, label: t('準備 30 食物做路糧') },
                          { type: 'npc_affinity', npcId: 'ma_qiang', target: 65, label: t('馬強好感度達到 65') },
                      ]},
                ],
                rewards: { reputation: 12, silver: 60 },
                outcomes: {
                ...
                onComplete: t('你們找到了傳說中的千年古木！馬強如獲至寶地撫摸著木材。'),
                npcHints: {
                    ma_qiang: { minAffinity: 40, hint: t('有件事...我年輕時在北山發現過一棵千年古木...') },
                },
            },
            {
                ...
                description: t('馬強想建一座專業的木工工坊，提升全鎮的建設能力...'),
                icon: '🔨',
                routes: [
                    { id: 'build', label: t('幫他建工坊'), icon: '🏗️',
                      conditions: [
                          { type: 'resource', resource: 'wood', target: 100, label: t('提供 100 木材') },
                          { type: 'resource', resource: 'metal', target: 15, label: t('提供 15 金屬做工具') },
                      ]},
                ],
                rewards: { reputation: 15, silver: 80 },
                outcomes: {
                ...
                onComplete: t('馬強的工坊建成了！全鎮的建設速度都提升了。'),
                npcHints: {
                    ma_qiang: { minAffinity: 55, hint: t('如果有一間正式的工坊，我能做出更好的東西...') },
                },
            },
        ],
    },
...
const NPC_INDUSTRY_BINDINGS = {
    'ma_qiang': {
        industry: 'woodcutting', name: t('馬強（木匠）'),
        tiers: [
            { affinity: 10, effect: 'hint', desc: t('透露哪片森林木材最好') },
            { affinity: 30, effect: 'shortcut', desc: t('教你辨認木材品種（硬木採集捷徑）'), bonus: 0.05 },
            { affinity: 50, effect: 'quest', desc: t('千年古木支線任務'), questId: 'ma_qiang_masterwork' },
            { affinity: 70, effect: 'supervisor', desc: t('自願當伐木場主管'), bonus: 0.25 },
            { affinity: 90, effect: 'legendary', desc: t('傳說工具——「這把斧頭跟了我一輩子，現在交給你。」'), bonus: 0.35 },
        ],
    },
    'wu_da': {
        industry: 'mining', name: t('吳達（礦工）'),
        tiers: [
            { affinity: 30, effect: 'hint', desc: t('告訴你哪裡有好石頭') },
            { affinity: 50, effect: 'quest', desc: t('大理石礦脈任務'), questId: 'wu_da_old_mine' },
            { affinity: 70, effect: 'secret', desc: t('帶你去秘密礦脈'), bonus: 0.20 },
        ],
    },
    'liu_jun': {
        industry: 'farming', name: t('劉俊（農夫）'),
        tiers: [
            { affinity: 30, effect: 'hint', desc: t('分享種植技巧'), bonus: 0.05 },
            { affinity: 50, effect: 'quest', desc: t('爺爺的種植手札'), questId: 'liu_jun_grandpa' },
            { affinity: 70, effect: 'automate', desc: t('自動幫你照顧農田'), bonus: 0.20 },
        ],
    },
    'zhang_hao': {
        industry: 'smithing', name: t('張豪（鐵匠）'),
        tiers: [
            { affinity: 30, effect: 'quality', desc: t('打造工具品質更高'), bonus: 0.05 },
            { affinity: 50, effect: 'quest', desc: t('傳說中的鑄劍術'), questId: 'zhang_hao_sword' },
            { affinity: 70, effect: 'master', desc: t('開放大師級鍛造'), bonus: 0.25 },
        ],
    },
    'zhao_xia': {
        industry: 'trade', name: t('趙霞（商人）'),
        tiers: [
            { affinity: 30, effect: 'discount', desc: t('交易價格優惠'), bonus: 0.05 },
            { affinity: 50, effect: 'quest', desc: t('新的貿易路線'), questId: 'zhao_xia_route' },
            { affinity: 70, effect: 'network', desc: t('打開商人網絡'), bonus: 0.20 },
        ],
    },
};
...
class NPCQuestSystem {
    ...
    _checkTriggers(world) {
        ...
        for (const [npcId, npcData] of Object.entries(NPC_PERSONAL_QUESTS)) {
            for (const quest of npcData.quests) {
                ...
                world.logMessage?.('quest', `💫 ${npcData.name}${t('的個人任務')}「${quest.title}」${t('已觸發')}！`);
                if (world.dailyNews) {
                    world.dailyNews.collectEvent('quest', `${npcData.name}${t('似乎有事情想找人幫忙')}...`, 6, [npcData.name]);
                }
            }
        }
    }
    ...
    _completeQuest(questId, routeId, questDef, world) {
        ...
        if (questDef.rewards) {
            for (const [resource, amount] of Object.entries(questDef.rewards)) {
                if (resource === 'reputation') {
                    ...
                    world.stockpile?.add(resource, amount, world.tickCount, `${t('任務獎勵')}：${questDef.title}`);
                }
            }
        }
        ...
        world.logMessage?.('quest', `🎉 ${t('完成了')}${npcName}${t('的個人任務')}「${questDef.title}」！（${route?.icon || ''} ${route?.label || routeId}）`);
        if (questDef.onComplete) {
            world.logMessage?.('quest', `📖 ${questDef.onComplete}`);
        }
        if (world.dailyNews) {
            world.dailyNews.collectEvent('quest', `${npcName}${t('的心願')}「${questDef.title}」${t('達成了')}！`, 8, [npcName]);
        }
    }
            ...
            for (const tier of binding.tiers) {
                if (affinity >= tier.affinity && tier.bonus) {
                    ...
                    if (!this.storyFlags[tierKey]) {
                        ...
                        world.logMessage?.('industry', `📈 ${npcName}${t('的好感度效果')}：${tier.desc}`);
                    }
                }
            }
        }
        ...
        for (const quest of npcData.quests) {
            ...
            if (this.quests[quest.id]?.status === 'active') {
                hints.push({
                    ...
                    hint: `${t('你目前有一個未完成的心願')}：「${quest.title}」——${quest.description}`,
                    type: 'active',
                });
            }
    ...
    getIndustryBindingContext(npcId, playerAffinity) {
        ...
        return `${t('你因為和玩家的關係好')}，${latest.desc}。`;
    }
