...
在 Phase 0–3 觀賞版上加入時鐘、需求、作息、技能成長、A* 尋路、進出建築與卡住復原。兩鎮範例可直接開啟；預設暫停，WASD／方向鍵可直接移動旅人，按「▶ 開始」則推進村民作息。這是分階段試玩版，現已加入 NPC 本地規則對話、八卦傳播、每日戀愛／分離、仇怨、派系事件、每日想法更新、日常心聲、觀星互動與夜間惡作劇；尚未包含建設、AI 對話、經濟、婚禮演出及任務模擬。
